...
INSERT INTO monitoramento (id_internamento, hora, fc, fr, etco2, spo2, ps, pd, pm, tc, glicemia) VALUES (1, 0, 3.2, 4.7, 1.2, 0.5, 32.0, 12.1, 55.3, 31.6, 3.0);
INSERT INTO monitoramento (id_internamento, hora, fc, fr, etco2, spo2, ps, pd, pm, tc, glicemia) VALUES (1, 5, 5.2, 3.7, 2.2, 60.5, 372.0, 8.1, 57.3, 61.6, 5.0);
INSERT INTO monitoramento (id_internamento, hora, fc, fr, etco2, spo2, ps, pd, pm, tc, glicemia) VALUES (2, 1, 5.2, 3.7, 2.2, 50.5, 52.0, 7.1, 7.3, 81.6, 4.0);
INSERT INTO monitoramento (id_internamento, hora, fc, fr, etco2, spo2, ps, pd, pm, tc, glicemia) VALUES (2, 3, 54.2, 5.7, 4.2, 5.5, 32.0, 4.1, 54.3, 6.6, 5.6);
