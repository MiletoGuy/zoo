...
function AutServMed() {
    return (
        <div className='app'>
            ...
            <div class="checkbox2">
                <input class="checkbox" type="checkbox"></input>Autorizo o profissional a examinar e/ou tratar e/ou
                proceder aos testes diagnósticos
                complementares que julgar necessários com base no exame clínico do animal e testes relacionados.
            </div>
            <div class="checkbox2">
                <input class="checkbox" type="checkbox"></input>Autorizo a aplicação de sedativos e/ou anestésicos
                necessários para proceder aos testes ou
            ...
            <div class="checkbox2">
                <input class="checkbox" type="checkbox"></input>Caso venha a ocorrer à morte do animal, dou permissão
